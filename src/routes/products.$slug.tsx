...
export const Route = createFileRoute("/products/$slug")({
  ...
  head: ({ params }) => ({
    meta: [
      ...
      {
        name: "description",
        content: `Buy ${params.slug.replace(/-/g, " ")} at Clab from tieflab.`,
      },
    ],
  }),
              ...
              <div className="mt-3 flex gap-2 overflow-x-auto">
                {gallery.map((src, i) => (
                  <button
                    ...
                    className={
                      "size-16 shrink-0 overflow-hidden rounded ring-1 " +
          ...
          <div>
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              >
                <Heart
                  className={
                    "size-5 " + (wished ? "fill-accent stroke-accent" : "stroke-foreground")
                  }
                />
              </button>
            </div>
