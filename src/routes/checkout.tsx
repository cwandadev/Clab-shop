    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
        ...
        <form
          ...
          className="mt-8 grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8"
        >
              ...
              {cart.map((i) => (
                <li key={i.id} className="flex justify-between gap-2">
                  <span className="truncate">
                    {i.name} <span className="font-mono text-muted-foreground">×{i.quantity}</span>
                  </span>
                  <span className="font-mono">
                    {formatPrice(i.price_usd * i.quantity, currency)}
                  </span>
                </li>
              ))}
            </ul>
            ...
            <div className="mt-4 border-t border-border pt-4 text-center">
              ...
              >
                <svg viewBox="0 0 24 24" className="size-3.5 fill-current">
                  <path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38a9.87 9.87 0 0 0 4.74 1.21h.01c5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.82 9.82 0 0 0 12.04 2Z" />
                </svg>
                Order via WhatsApp
              </a>
